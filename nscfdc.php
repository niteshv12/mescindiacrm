...
<html lang="en">
	<head>
		...
		<title>National Schedule Caste Finance and Development Corporation </title>
		...
		<div class="page-wrapper page-wrapper-post">
		  <!-- HEADER	 -->
			...
			<section class="page-title" >
				<div class="container">
					<h2 class="underline_bold"><b>National Schedule Caste Finance and Development Corporation </b></h2>
				...
				<div class="container">
					<div class="row">
						<div id="main" class="col-md-9">
							<h1 class="underline_small">National Schedule Caste Finance and Development Corporation </h1>							
							
							<div class="row">
							<div class="col-md-4">
								<div class="block-content">							
									<img src="images/special-projects/nscfdc.jpg" width="180" alt="image">
								</div>
							</div>	<!-- .col-sm-6 -->				
							<div class="col-md-8 padding-left">
								<p class="normal">In India, the schedule caste and schedule tribe consist of 16.6% and 8.6%, respectively (according to the 2011 census). MESC partnered with National Schedule Caste Finance and Development Corporation in the year 2018 with a mission to promote prosperity among Scheduled Castes by improving flow of financial assistance and through skill development & other innovative initiatives. </p>
							</div><!-- .overview_right -->	
							</div>
						
							<div class="post-text">	
								
								<p class="normal">Eligibility criteria for being a part of this scheme include, the beneficiary should be from the Scheduled Castes Community. The Annual family income of the beneficiary should not exceed Double the Poverty Line (DPL) income limit which is presently upto Rs.98,000/- p.a. for rural areas and Rs.1,20,000/- p.a. for urban areas. NSFDC provides term loan up to 90% of the cost of project, subject to the condition that the SCAs contribute their share of assistance as per their schemes and provide the required subsidy besides tying up of the financial resources from other sources available.</p>
								
								<p class="normal"> MESC has successfully trained 660 candidates and have certified 550+ candidates in 2019-2020 FY.  to help them be economically independent.</p>
						...
						<div id="sidebar" class="col-md-3">							
							...
							<ul class="menu-sidebar">
									<li><a href="pradhan-mantri-kaushal-vikas-yojana">PMKVY Job Roles</a></li>
									<li><a href="curriculum-content">Model Curriculum</a></li>
									<li><a href="qualification-packs">Qualification Packs</a></li>
									<li><a href="certified-trainers">Certified Trainers</a></li>
									<li><a href="training-providers">Training Provider</a></li><li><a href="training-of-assessors">Training of Assessors</a></li>							</ul>
						</div>
                        <!-- .menus -->
						<div class="brochures4">
							<a href="images/pdf/brochure/MESC New brochure.pdf" target="_blank" class="button btn-gray btn_normal caps_normal"><i class="fa fa-file-pdf-o" aria-hidden="true"></i><strong>Download MESC Brochure</strong></a>
						</div><!-- .brochures -->
						<br>
						...
						<div class="skilling">
							<h4 class="small-h4">Skilling Youth Building Nation</h4>
							<p class="caps_large">The more we give importance to skill development, the more competent will be our youth</p>
							<a href="contact-us" class="button btn-gray btn_normal caps_normal" style="color:black;">Recieve a Callback</a>
						</div><!-- help -->

						<!-- .testimonial-content -->
						<div class="brochures4">
							<a href="contact-us" class="button btn-gray btn_normal caps_normal">Enquire Online</a>
						</div>
						...
						<div class="share">
							<ul class="list-inline pull-right">
								<li>share:</li>
								<li><a href="https://www.facebook.com/MESCINDIA.ORG/" target="_blank" class="facebook" style="background:#49639c;"><i class="fa fa-facebook"></i></a></li>
								<li><a href="https://twitter.com/mesc_india" target="_blank" class="twitter"><i class="fa fa-twitter"></i></a></li>
								<li><a href="https://in.linkedin.com/in/mesc-india-53384566" target="_blank" class="linkedin"><i class="fa fa-linkedin"></i></a></li>
