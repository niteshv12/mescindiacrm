<div class="bg_dark_blue">
	<div class="container-fluid text-center" style=" display:flex; align-items: center;justify-content:center;">
		<ul class="white contact-block pull-right ">
			<li class="time tophead" style="margin-top:10px;"><a class="button  caps_normal btn_small" href="e-magazine" target="_blank"><i class="fa fa-download" aria-hidden="true"></i> MEDIA TALKBACK </a> </li>
			<li class="time tophead"><a class="button  caps_normal btn_small" href="http://mecat.in/" target="_blank"> MECAT</a> </li>
			<li class="time tophead"><a class="button  caps_normal btn_small" href="http://mescindia.org/awsitc/" target="_blank"> AWSITC</a> </li>
			<li class="time tophead" style="margin-top:10px;"><a class="button  caps_normal btn_small" href="http://vidyadaan.net/" target="_blank"> VIDYADAAN</a> </li>
			<li class="time tophead" style="margin-top:10px;"><a class="button  caps_normal btn_small" href="https://mescindia.org/manthan/" target="_blank"> Manthan</a> </li>
			<li class="time tophead" style="margin-top:10px;"><a class="button  caps_normal btn_small" href="pradhan-mantri-kaushal-vikas-yojana" target="_blank"> PMKVY 4.0</a> </li>
			<li class="time tophead" style="margin-top:10px;"><a class="button  caps_normal btn_small" href="avgc-report" target="_blank">AVGC Report</a> </li>
			<li class="time tophead" style="margin-top:10px;"><a class="button caps_normal btn_small" href="images/RFP_PMKVY 4.0_RPL.pdf" target="_blank">RFP FOR PMKVY 4.0-RPL</a> </li>
			<li class="time tophead" style="margin-top:10px;"><a class="button  caps_normal btn_small" href="images/RFP_Impact_Study_Report_Maharashtra.pdf" target="_blank">EOI for Maharashtra</a> </li>
		</ul>
	</div>
</div>
				...
				<div class="container">
					<div class="row">
						<div class="navbar-header">
							...
							<a class="navbar-brand" href="home"><img src="images/logo_dark.png" alt="logo"></a>
						</div>
						<div class="collapse navbar-collapse pull-right">
							<ul class="nav big-padding navbar-nav color-gray">
								...
								<li class="active">
									...
									<ul class="dropdown-menu " style="-::-webkit-scrollbar{">
										...
										<li><a href="skill-ecosystum.php">Skill Ecosystem</a></li>
									</ul>
								</li>
								<li>
									<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Resources<span class="caret"></span></a>
									<ul class="dropdown-menu">
										<li><a href="qualification-packs.php">Qualification Packs</a></li>
										<li><a href="curriculam.php">Curriculum &amp; Content</a></li>
										<li><a href="trainers-guide.php">Trainers Guide</a></li>
								...
								<li>
									...
									<ul class="dropdown-menu">
										...
										<li>
											...
											<ul class="dropdown-menu">
												<li><a href="nskfdc.php">NSKFDC</a></li>
												<li><a href="nbcfdc.php">NBCFDC </a></li>
												<li><a href="nscfdc.php">NSCFDC</a></li>
											</ul>
										</li> <!-- li Investments-->
										...
										<li>
											...
											<ul class="dropdown-menu">
												...
												<li><a href="ddugky.php">Ddugky </a></li>
												<li><a href="community.php">Community Colleges </a></li>
												<li><a href="ugcbvoc.php">Ugc – B.voc. </a></li>
											</ul>
										</li><!-- li Investments-->
										<li><a href="Affiliated.php">Affiliated Training Centers</a></li>
										<li>
										...
										<li><a href="images/pdf/calendar/Training Calender_Jan'2024 to Mar'2024.pdf" target="_blank">TOT-TOA Calendar</a></li>
										...
										<li><a href="affiliated-assesment-agencies">Affiliated Assesment Agencies</a>
										</li>
								...
								<li class="">
									...
									<ul class="dropdown-menu">
										...
										<li><a href="https://creativewarriors.co.in/partners"> Universities & Colleges</a></li>
										<li><a href="https://creativewarriors.co.in/partners">Industry Partners</a></li>
